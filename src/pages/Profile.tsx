        ...
        {isEditing ? (
          ...
          >
            <Form className="space-y-4">
              ...
              {/* Add similar Field components and error messages for other fields */}
              <div className="flex flex-col">
            ...
            <div className="bg-white p-4 rounded-lg shadow-md">
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col">
                    <label className="text-gray-700 text-sm font-bold mb-1">Gender</label>
                    <span className="px-2 py-1 border rounded-md">{user?.gender}</span>
                  </div>
                  <div className="flex flex-col">
                    <label className="text-gray-700 text-sm font-bold mb-1">Phone Number</label>
                    <span className="px-2 py-1 border rounded-md">{user?.phoneNumber}</span>
                  </div>
                  <div className="flex flex-col">
                    <label className="text-gray-700 text-sm font-bold mb-1">Date of Birth</label>
                    <span className="px-2 py-1 border rounded-md">{user?.dateOfBirth}</span>
                  </div>
                </div>
              </div>

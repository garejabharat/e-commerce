    ...
    <div className="products px-[70px]">
            ...
            <div className="grid grid-cols-4  gap-10  custom-card ">
                {relatedProductsabc.map((product) => (
                        ...
                        <div key={product.id} className="w-full max-h-[700px] bg-white border border-gray-200 rounded-lg custom-inner  shadow-2xl">
                          ...
                          <div className="px-5 pb-5">
                            <p  onClick={()=>handelReplaceUrl(product.id)} className='cursor-pointer'>

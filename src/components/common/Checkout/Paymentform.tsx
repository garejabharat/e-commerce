        ...
        <div>
            ...
            <div className="mb-4">
                <div className='flex'>
                    ...
                    <label htmlFor="cardNumber">Card Number</label></div>
                <Field
                    type="text"
                    name="cardNumber"
                    id="cardNumber"
            ...
            <div className="mb-4">
                <div className='flex'>
                    ...
                    <label htmlFor="cardHolderName">Cardholder Name</label></div>
                <Field
                    type="text"
                    name="cardHolderName"
                    id="cardHolderName"
            ...
            <div className="flex flex-wrap mb-4">
                <div className="w-1/2 pr-2">
                    <div className='flex'>
                        ...
                        <label htmlFor="expirationDate">Expiration Date</label></div>
                    <Field
                        type="text"
                        name="expirationDate"
                        id="expirationDate"
                ...
                <div className="w-1/2 pl-2">
                    <div className='flex'>
                        <img width="30" height="30" src="https://img.icons8.com/emoji/30/credit-card-emoji.png" alt="credit-card-emoji" />
                        <label htmlFor="cvv">CVV</label></div>
                    <Field
                        type="text"
                        name="cvv"
                        id="cvv"

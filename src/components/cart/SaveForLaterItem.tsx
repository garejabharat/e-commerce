...
const SaveForLaterItem: React.FC<CartItem> = ({
  ...
  const handleRemoveFromSaveForLater = () => {
    ...
    enqueueSnackbar(`Successfully removed ${title.substring(0, 55)}... been Removed from your Saved Items!`, {
      variant: "success",
    });  };
  ...
  const moveToCartHandler = () => {
    ...
    dispatch(removeFromSaveForLater(id));
    enqueueSnackbar(`You've Added ${title.substring(0, 55)}... with quantity ${quantity} successfully to your Cart!`, { variant: "success" });  };
